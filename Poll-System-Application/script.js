const options = [
    {id:"option1", text:"C++", votes: 0},
    {id:"option2", text:"Python", votes: 0},
    {id:"option3", text:"JavaScript", votes: 0},
    {id:"option4", text:"Java", votes: 0},
    {id:"option5", text:"Others", votes: 0},
];

function submitVote() {
    const selectedOption = document.querySelector('input[name="poll"]:checked'); //checked is a pseudo class
